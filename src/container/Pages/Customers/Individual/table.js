...
import FormCountry from "../../../../layouts/customer/individual/form";
            ...
            .then((res) => {
                if (res.json.code === "403") {
                    ...
                    res
                        ...
                        .data
                        .map((data) => {
                            datas.push(createData(data.id, data.cif_number, data.name, data.phone, Func.FormatRp(data.os), data.status));
                        });
                    this.setState({
