...
function createData(id,cif_number, name, hp, os, status) {
    return { id,cif_number, name, hp, os, status };
}
  
const headCells = [
    { id: "cif_number", numeric: false, disablePadding: false, label: "No.CIF" },
    { id: "name", numeric: false, disablePadding: false, label: "Nasabah" },
    { id: "hp", numeric: false, disablePadding: false, label: "No.HP" },
    { id: "os", numeric: false, disablePadding: false, label: "Total OS" },
            ...
            .then((res) => {
                if (res.json.code == "403") {
                    ...
                    res
                        ...
                        .data
                        .map((data) => {
                            datas.push(createData(data.id,data.cif_number,data.name,data.phone_number,Func.FormatRp(data.os),data.status));
                        });
                    this.setState({
                        ...
                        <div
                            ...
                            <Box display="flex">
                                <Box flexGrow={1}>
                                    ...
                                    <Typography variant="h9" className={classes.textperdata}>
                                        Total: {this.state.total_data} nasabah
                                    </Typography>
                                </Box>
                            </Box>
                        </div>
