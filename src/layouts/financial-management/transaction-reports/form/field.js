...
import "../../../customer/individual/form/node_modules/react-datepicker/dist/react-datepicker.css";
...
class Form extends React.Component {
  ...
  componentDidMount() {
    if (this.props.type == "Ubah") {
      fetch(
        env.managementApi + env.apiPrefixV1+
          "/companies" +
          "/" +
          this.props.id_comp,
        {
        ...
        .then((json) => {
          ...
          val["city_id"] =
            json.data.company_detail.city_id +
            "||" +
            json.data.company_detail.city_name;

          val["company_pics[0].id"] =
            json.data.company_detail.company_pics[0].id;
          val["company_pics[0].name"] =
            json.data.company_detail.company_pics[0].name;
          val["company_pics[0].position"] =
            json.data.company_detail.company_pics[0].position;
          val["company_pics[0].identity_number"] =
            json.data.company_detail.company_pics[0].identity_number;
          val["company_pics[0].identity_type"] =
            json.data.company_detail.company_pics[0].identity_type;
          val["company_pics[0].phone_number"] =
            json.data.company_detail.company_pics[0].phone_number;
          val["company_pics[0].address"] =
            json.data.company_detail.company_pics[0].address;

          val["company_pics[1].id"] =
            json.data.company_detail.company_pics[1].id;
          val["company_pics[1].name"] =
            json.data.company_detail.company_pics[1].name;
          val["company_pics[1].position"] =
            json.data.company_detail.company_pics[1].position;
          val["company_pics[1].identity_number"] =
            json.data.company_detail.company_pics[1].identity_number;
          val["company_pics[1].identity_type"] =
            json.data.company_detail.company_pics[1].identity_type;
          val["company_pics[1].phone_number"] =
            json.data.company_detail.company_pics[1].phone_number;
          val["company_pics[1].address"] =
            json.data.company_detail.company_pics[1].address;

          val["company_pics[2].id"] =
            json.data.company_detail.company_pics[2].id;
          val["company_pics[2].name"] =
            json.data.company_detail.company_pics[2].name;
          val["company_pics[2].position"] =
            json.data.company_detail.company_pics[2].position;
          val["company_pics[2].identity_number"] =
            json.data.company_detail.company_pics[2].identity_number;
          val["company_pics[2].identity_type"] =
            json.data.company_detail.company_pics[2].identity_type;
          val["company_pics[2].phone_number"] =
            json.data.company_detail.company_pics[2].phone_number;
          val["company_pics[2].address"] =
            json.data.company_detail.company_pics[2].address;
  ...
  handleSubmit(type) {
    ...
    if (validate.success) {
      var dataCity = this.state.value["city_id"];
      var res = dataCity.split("||");
      fetch(
        env.managementApi + env.apiPrefixV1 +
          "/companies/" +
          (type == "Tambah" ? "" : this.props.id_comp),
        {
          ...
          body: JSON.stringify({
            company: {
              ...
              branch_office_id:
                this.state.value["branch_office_id"] == undefined
                  ? "123124"
                  : this.state.value["branch_office_id"],
              name: this.state.value["name"],
              branch_office_name:
                this.state.value["branch_office_name"] == undefined
                  ? "Kancab Bandung"
                  : this.state.value["branch_office_name"],
              phone_number: this.state.value["phone_number"],
              area_code:
                this.state.value["area_code"] == undefined
                  ? "+62"
              ...
              company_pics_attributes: [
                {
                  ...
                  phone_number: this.state.value[
                    "company_pics[0].phone_number"
                  ],
                  position: this.state.value["company_pics[0].position"],
                  identity_number: this.state.value[
                    "company_pics[0].identity_number"
                  ],
                  identity_type:
                ...
                },
                {
                  ...
                  phone_number: this.state.value[
                    "company_pics[1].phone_number"
                  ],
                  position: this.state.value["company_pics[1].position"],
                  identity_number: this.state.value[
                    "company_pics[1].identity_number"
                  ],
                  identity_type:
                ...
                },
                {
                  ...
                  phone_number: this.state.value[
                    "company_pics[2].phone_number"
                  ],
                  position: this.state.value["company_pics[2].position"],
                  identity_number: this.state.value[
                    "company_pics[2].identity_number"
                  ],
                  identity_type:
  ...
  render() {
    ...
    if (this.state.value["name"] != undefined || this.props.type == "Tambah") {
      return (
        <div>
          <DialogContent>
                            ...
                            startAdornment: (
                              ...
                              >
                                <Select
                                  ...
                                  onChange={(event) => {
                                    this.handleChange(event, "area_code");
                                  }}
                                >
                    ...
                    >
                      ...
                      >
                        ...
                        <TextField
                          ...
                          onChange={(event) => {
                            this.handleChange(event, "tax_number");
                          }}
                          name="tax_number"
                        />
                      </Grid>
                      ...
                      >
                        <div>
                          <text className={classes.label1}>Nomor CIF</text>
                          <text className={classes.starts1}>*</text>
                        </div>
                        <TextField
                          size="small"
                          ...
                          onChange={(event) => {
                            this.handleChange(event, "cif_number");
                          }}
                          name="cif_number"
                        />
                      </Grid>
                    ...
                    >
                      ...
                      >
                        ...
                        <Select
                          ...
                          error={this.state.validator["city_id"]}
                          helperText={this.state.validator["city_id"]}
                          value={this.state.value["city_id"]}
                          onChange={(event) => {
                            this.handleChange(event, "city_id");
                          }}
                        >
                          <MenuItem value={null}>Pilih Kota</MenuItem>
                          {this.state.cities.map((data) => {
                            return (
                              <MenuItem value={data.id.$oid + "||" + data.name}>
                                {data.name +
                                  ", " +
                                  data.province.name +
                                  ", " +
                  ...
                  >
                    ...
                    >
                      ...
                      <TextField
                        ...
                        helperText={
                          this.state.validator["company_pics[0].name"]
                        }
                        value={this.state.value["company_pics[0].name"]}
                        onChange={(event) => {
                          this.handleChange(event, "company_pics[0].name");
                        }}
                        name="company_pics[0].name"
                      />
                    </Grid>
                    ...
                    >
                      ...
                      <TextField
                        ...
                        value={
                          this.state.value["company_pics[0].identity_number"]
                        }
                        onChange={(event) => {
                          this.handleChange(
                            event,
                  ...
                  >
                    ...
                    >
                      ...
                      <TextField
                        ...
                        error={
                          this.state.validator["company_pics[0].phone_number"]
                        }
                        helperText={
                          this.state.validator["company_pics[0].phone_number"]
                        }
                    ...
                    >
                      ...
                      <TextareaAutosize
                        ...
                        onChange={(event) => {
                          this.handleChange(event, "company_pics[0].address");
                        }}
                        name="company_pics[0].address"
                        InputProps={{
                          endAdornment: this.state.validator[
                            "company_pics[0].address"
                          ] ? (
                            <InputAdornment position="start">
                              <img src={Icon.warning} />
                            </InputAdornment>
                  ...
                  >
                    ...
                    >
                      ...
                      <TextField
                        ...
                        helperText={
                          this.state.validator["company_pics[1].name"]
                        }
                        value={this.state.value["company_pics[1].name"]}
                        onChange={(event) => {
                          this.handleChange(event, "company_pics[1].name");
                        }}
                        name="company_pics[1].name"
                      />
                    </Grid>
                    ...
                    >
                      ...
                      <Select
                        ...
                        error={this.state.validator["company_pics[1].position"]}
                        helperText={
                          this.state.validator["company_pics[1].position"]
                        }
                        value={this.state.value["company_pics[1].position"]}
                        onChange={(event) => {
                          this.handleChange(event, "company_pics[1].position");
                        }}
                      >
                        <MenuItem value={null}>Pilih Jabatan</MenuItem>
                        <MenuItem value={"Direktur"}>Direktur</MenuItem>
                    ...
                    >
                      ...
                      <TextField
                        ...
                        value={
                          this.state.value["company_pics[1].identity_number"]
                        }
                        onChange={(event) => {
                          this.handleChange(
                            event,
                  ...
                  >
                    ...
                    >
                      ...
                      <TextField
                        ...
                        error={
                          this.state.validator["company_pics[1].phone_number"]
                        }
                        helperText={
                          this.state.validator["company_pics[1].phone_number"]
                        }
                    ...
                    >
                      ...
                      <TextareaAutosize
                        ...
                        onChange={(event) => {
                          this.handleChange(event, "company_pics[1].address");
                        }}
                        name="company_pics[1].address"
                        InputProps={{
                          endAdornment: this.state.validator[
                            "company_pics[1].address"
                          ] ? (
                            <InputAdornment position="start">
                              <img src={Icon.warning} />
                            </InputAdornment>
                  ...
                  >
                    <Grid
                      ...
                      <TextField
                        ...
                        helperText={
                          this.state.validator["company_pics[2].name"]
                        }
                        value={this.state.value["company_pics[2].name"]}
                        onChange={(event) => {
                          this.handleChange(event, "company_pics[2].name");
                        }}
                        name="company_pics[2].name"
                      />
                    </Grid>
                    ...
                    >
                      ...
                      <Select
                        ...
                        error={this.state.validator["company_pics[2].position"]}
                        helperText={
                          this.state.validator["company_pics[2].position"]
                        }
                        value={this.state.value["company_pics[2].position"]}
                        onChange={(event) => {
                          this.handleChange(event, "company_pics[2].position");
                        }}
                      >
                        <MenuItem value={null}>Pilih Jabatan</MenuItem>
                        <MenuItem value={"Direktur"}>Direktur</MenuItem>
                    ...
                    >
                      ...
                      <TextField
                        ...
                        value={
                          this.state.value["company_pics[2].identity_number"]
                        }
                        onChange={(event) => {
                          this.handleChange(
                            event,
                  ...
                  >
                    ...
                    >
                      ...
                      <TextField
                        ...
                        error={
                          this.state.validator["company_pics[2].phone_number"]
                        }
                        helperText={
                          this.state.validator["company_pics[2].phone_number"]
                        }
                    ...
                    >
                      ...
                      <TextareaAutosize
                        ...
                        onChange={(event) => {
                          this.handleChange(event, "company_pics[2].address");
                        }}
                        name="company_pics[2].address"
                        InputProps={{
                          endAdornment: this.state.validator[
                            "company_pics[2].address"
                          ] ? (
                            <InputAdornment position="start">
                              <img src={Icon.warning} />
                            </InputAdornment>
